// Adapted from features/dashboard/components/SalesOverviewChart.tsx
// (closed phase F4) -- same per-feature isolation precedent as
// dateRange.ts, plotting DailySalesPoint from /reports/sales/timeseries
// instead of /dashboard/sales-overview (identical shape).
...
export interface SalesTimeseriesChartProps {
